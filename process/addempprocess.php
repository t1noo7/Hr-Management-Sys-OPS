...
if (in_array($filecheck, $fileextstored)) {
    ...
    $sql = "INSERT INTO `employee`(`firstName`, `lastName`, `email`, `password`, `birthday`, `gender`, `contact`, `nid`,  `address`, `dept`, `degree`, `pic`) VALUES ('$firstname','$lastName','$email','$passWord','$birthday','$gender','$contact','$nid','$address','$dept','$degree','$destinationfile')";
    ...
    $sqlS = "INSERT INTO `salary`(`id`, `base`, `bonus`) VALUES ('$last_id','$salary',0)";
